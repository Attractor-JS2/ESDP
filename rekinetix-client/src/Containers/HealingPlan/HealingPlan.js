...
class HealingPlan extends Component {
  render() {
    ...
    const firstStageProcedureNames = ["Функциональный массаж", "Расслабление", "Ультразвук", "Плазмолифтинг"];
    const secondStageProcedureAreas = ["Грудной отдел позвоночника", "Шейный отдел позвоночника", "Поясничный отдел позвоночника"];
    const secondStageProcedureNames = ["Функциональный массаж", "Нефункциональный массаж", "Тракция", "Компрессия", "Мобилизиация"];
    const thirdStageProcedureAreas = ["Нижний цилиндр", "Верхний цилиндр", "Коленный сустав"];
    const thirdStageProcedureNames = ["Функциональный массаж", "Немассаж", "Упражнение: активация", "Упражнение: тренировка", "Стабилизация"];
    const fourthStageProcedureAreas = ["Передняя лента", "Задняя лента"];
    const fourthStageProcedureNames = ["Функциональный массаж", "Немассаж", "Тренировка"];
